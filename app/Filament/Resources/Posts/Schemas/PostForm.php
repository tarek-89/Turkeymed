                ...
                Section::make('Content')
                    ...
                    ->components([
                        ...
                        TextInput::make('slug')
                            ...
                            ->maxLength(300)
                            ->live(onBlur: true)
                            ->helperText('URL path of the post. Do not change on migrated posts — it preserves SEO.')
                            ->unique(
                                ignoreRecord: true,
                        ...
                        RichEditor::make('body')
                            ...
                            // When creating a translation, start from the source post's content
                            ->default(function (): ?string {
                                $sourceId = request()->integer('from');

                                return $sourceId ? Post::find($sourceId)?->body : null;
                            }),
                    ...
                    ->components([
                        Group::make([
                            ...
                            TextInput::make('focus_keyword')
                                ->live(debounce: 600)
                                ->helperText('The main search term this post should rank for.'),
                        ]),
