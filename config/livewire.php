...
return [
    ...
    */
    ...
    'payload' => [
        ...
        'max_nesting_depth' => 20,   // Raised from 10: Filament 5 RichEditor syncs a nested ProseMirror tree over Livewire; deep body content (nested lists, blockquotes, tables) exceeds the default. 20 clears real content while keeping the DoS guard meaningful.
